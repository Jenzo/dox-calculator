 ...
 * 
 */
@WebServiceClient(name = "WebServiceCalculation", targetNamespace = "http://webservice.calculation.business.calculator/", wsdlLocation = "http://localhost:8080/WebServiceCalculation/WebServiceCalculation?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEBSERVICECALCULATION_QNAME = new QName("http://webservice.calculation.business.calculator/", "WebServiceCalculation");
    ...
    public WebServiceCalculation getWebServiceCalculationPort() {
        return super.getPort(new QName("http://webservice.calculation.business.calculator/", "WebServiceCalculationPort"), WebServiceCalculation.class);
    }
    ...
    public WebServiceCalculation getWebServiceCalculationPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.calculation.business.calculator/", "WebServiceCalculationPort"), WebServiceCalculation.class, features);
    }
